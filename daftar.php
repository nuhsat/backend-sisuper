<?php
  ...
  //mengambil id sebelumnya trus di tambah 1
  ...
  //
    ...
    if (isset($postdata)) {
        ...
        if(mysqli_num_rows($query_regis)){
            ...
            $query_register = mysqli_query($connect,"INSERT INTO user (id_user, nama_user, email_user, password_user, telepon_user, alamat_user) VALUES ('$id', '$nama', '$email', '$encrypt_password', '$telepon','$alamat') ");
